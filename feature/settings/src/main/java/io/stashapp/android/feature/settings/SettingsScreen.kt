...
fun SettingsScreen(
    ...
    LazyColumn(
        ...
        item {
            Surface(
                ...
                Row(
                    ...
                    // Icon container
                    val accentColors = io.stashapp.android.core.designsystem.theme.LocalAccentColors.current
                    Box(
                        modifier = Modifier
                            .size(40.dp)
                            .background(
        ...
        // Quick search field (non-functional until Plan 6.3)
        item {
            Surface(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 14.dp, vertical = 4.dp)
                    .clickable { /* Plan 6.3 wires search overlay */ },
                color = SpineColors.Surface,
                shape = ShapeSmall,
                border = BorderStroke(1.dp, SpineColors.Border),
            ) {
        ...
        Column(Modifier.weight(1f)) {
            ...
            if (value.isNotEmpty()) {
                Text(
                    ...
                    color = io.stashapp.android.core.designsystem.theme.LocalAccentColors.current.primary,
                    modifier = Modifier.padding(top = 2.dp),
                )
            }
        }
